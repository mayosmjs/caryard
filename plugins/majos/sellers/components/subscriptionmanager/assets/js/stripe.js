                            ...
                            '<div class="text-center">' +
                                ...
                                '<form id="stripe-card-form">' +
                                    ...
                                    '<div class="flex flex-col gap-3">' +
                                        '<button type="submit" class="w-full btn-modern btn-blue py-4 text-base font-semibold tracking-wide">' +
                                            ...
                                            '</span>' +
                                        '</button>' +
                                        '<button type="button" id="cancel-stripe-btn" class="w-full btn-modern btn-cancel py-3 text-sm font-medium">' +
                                            'Cancel Payment' +
                                        '</button>' +
                                    '</div>' +
                                '</form>' +
